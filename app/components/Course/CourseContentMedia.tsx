...
import { AiFillStar, AiOutlineArrowLeft, AiOutlineRight, AiOutlineStar } from 'react-icons/ai';
import { BiMessage } from 'react-icons/bi';
import { VscVerifiedFilled } from 'react-icons/vsc';
import { format } from 'timeago.js';
import socketIO from "socket.io-client";
const ENDPOINT = process.env.NEXT_PUBLIC_SOCKET_SERVER_URI as any;
...
const CourseContentMedia:FC<Props> = ({data,id,user,refetch,activeVideo,setActiveVideo}) => {
...
console.log("ReviewExists:",isReviewExists);
   ...
   return (
    <div className="w-[95%] 800px:w-[86%] py-4 m-auto">
      ...
      <div className='w-full flex items-center justify-between my-3'>
        <div className={`${formStyles.button} dark:text-white text-black !w-[unset] !min-h-[40px] !py-[unset]
                  ...
                  return (
                    <div className="w-full my-5 dark:text-white text-black" key={index}>
                      ...
                      {user.role === "admin" && item.commentReplies.length === 0 && (
                        <span
                          className={`${formStyles.label} !ml-10 cursor-pointer`}
                          onClick={() => {
                      ...
                      {isReviewReply && reviewId === item._id && item.commentReplies.length === 0 && (

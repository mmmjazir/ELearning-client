...
const CourseDetails:FC<Props> = ({
 ...
 const {refetch} = useLoadUserQuery(undefined, {});
  ...
  const discountPercentage = (((data?.estimatedPrice - data?.price) /
                             data?.estimatedPrice) * 100).toFixed(0);
...
const handleOrder = (e:any) => {
  ...
  return (
    <div>
        <div className='w-[90%] h-auto mt-[80px] mb-[40px] m-auto py-5'>
            ...
            <div className='w-full md:w-[65%] md:pr-5'>
               ...
               <div className='flex items-center justify-between pt-3'>
                 <div className='flex items-center'>
                  ...
                  <h5 className='text-black dark:text-white mr-[5vh]'>{data?.purchased} Students</h5>
               </div>
       ...
       <div className="w-full">
            ...
            <div className="sticky top-[100px] left-0 z-50 w-full">
              ...
              <div className="flex items-center">
                {isPurchased ? (
                  <Link
                    className={`${formStyles.button} !w-[180px] my-3 font-Poppins cursor-pointer !bg-[crimson]`}
